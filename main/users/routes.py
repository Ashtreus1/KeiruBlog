...
from main.users.forms import Registration, Login, UpdateAccount, ResetRequestForm, ResetPassword
...
def login():
    ...
    if form.validate_on_submit():
        ...
        if user and bcrypt.check_password_hash(user.password, form.password.data):
            ...
            flash('Login unsuccessful! Please check your credentials carefully', 'danger')
    return render_template('login.html', title='Login Account', form=form)
